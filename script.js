...
function onReady() {
    ...
    $('.attack-btn dragon-blade').on('click', dragonBladeBtn);

    $('.attack-btn star-fire').on('click', starFireBtn);
...
// $('#hp-meter').progressbar({"value" , arcaneDamage});
$('#hp-meter').css("value" , arcaneDamage);
